function start() {
    ...
    $("#background-game").append("<div id='jogador' class='anima1'></div>");
    $("#background-game").append("<div id='inimigo1'class='anima2'></div>");
...
function colisao() {
    ...
    function explosao1(inimigo1X,inimigo1Y) {
        ...
        $("#explosao1").css("background-image" ,"url(/game/assets/imgs/explosao.png)");
        var div=$("#explosao1");
...
//Explos�o2
	...
	function explosao2(inimigo2X,inimigo2Y) {
        ...
        $("#explosao2").css("background-image", "url(/game/assets/imgs/explosao.png)");
        var div2=$("#explosao2");
...
function energia() {
    ...
    if (energiaAtual==3) {
        ...
        $("#energia").css("background-image", "url(/game/assets/imgs/energia3.png)");
    }

    if (energiaAtual==2) {
        
        $("#energia").css("background-image", "url(/game/assets/imgs/energia2.png)");
    }

    if (energiaAtual==1) {
        
        $("#energia").css("background-image", "url(/game/assets/imgs/energia1.png)");
    }

    if (energiaAtual==0) {
        
        $("#energia").css("background-image", "url(/game/assets/imgs/energia0.png)");
